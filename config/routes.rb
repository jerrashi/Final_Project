Rails.application.routes.draw do
  ...
  match("/", { :controller => "users", :action => "dashboard", :via => "get" })
  ...
  match("/users/:the_username/applications", {:controller => "users", :action => "applications", :via => "get"})
  match("/users/:the_username/projects", {:controller => "users", :action => "projects", :via => "get"})
